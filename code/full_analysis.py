...
class NewAnalysisRun:
    ...
    def get_pre_made_pop(self, pop_size: int):
        ...
        while len(pop) < pop_size:
            random_moves = list(map(axl.Action, np.random.randint(0, 1 + 1, (self.sequence_length, 1))))
    ...
    def start(self):
        ...
        cycler_objective = axl_dojo.prepare_objective(name="score", turns=self.sequence_length, repetitions=1)
        cycler_kwargs = {
