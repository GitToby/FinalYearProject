...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/INIT_POP_bs_v_gens_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/INIT_POP_mean_bs_diff_v_init_pop_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/GENS_mean_bs_diff_v_gens_all.pdf}
...
% \begin{figure}[h] 
% \includegraphics[width=1.0\textwidth, center]{plots/GENS_max_bs_v_gens_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/MUT_POT_bs_v_gen_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/MUT_POT_bs_diff_v_pot_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/MUT_FREQ_bs_v_gen_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/MUT_FREQ_bs_diff_v_freq_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/NEW_INIT_POP_bs_v_gen_all_old.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/NEW_INIT_POP_bs_v_gen_non_performers.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/NEW_GEN_bs_v_gen_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/NEW_MUT_POT_bs_v_gen_all.pdf}
...
\begin{figure}[h]
    \includegraphics[width=1.0\textwidth, center]{plots/NEW_MUT_FREQ_bs_v_gen_all.pdf}
...
Currently the only way of doing this is by seeing the whole Axelrod library upon initialising the opponent instance, Snippet~\ref{} shows the code for wrapping any given opponent with the seed command.

\begin{figure}
    \inputminted{python}{code_snippets/classWrappingFunction.py}
    \caption{A function for wrapping a player with a seed function call}\label{code:wrappingFunction}
\end{figure}
