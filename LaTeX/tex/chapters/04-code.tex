...
The main analysis was run using a factory class pattern, called \mintinline{python}{AnalysisRun} in the \mintinline{python}{full_analysis} module, show in Figure~\ref{code:AnalysisRun.py} in Appendix Chapter~\ref{apndx:code}.
